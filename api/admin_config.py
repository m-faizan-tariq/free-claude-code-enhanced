...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        secret=True,
        description="FreeLLMAPI OpenAI-compatible model router key (http://localhost:3001/v1).",
    ),
    ConfigFieldSpec(
        "MODELSCOPE_API_KEY",
        "ModelScope API Key",
        ...
        secret=True,
        description="ModelScope Inference API key ([modelscope.cn](https://modelscope.cn/my/api-keys)).",
    ),
    ConfigFieldSpec(
        "GEMINI_API_KEY",
        "Gemini API Key",
    ...
    ConfigFieldSpec(
        ...
        "ModelScope Base URL",
        "providers",
        settings_attr="modelscope_base_url",
