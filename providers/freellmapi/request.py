...
FreeLLMAPI is an OpenAI-compatible model router at http://localhost:3001/v1.
"""
...
def build_request_body(request_data: Any, *, thinking_enabled: bool) -> dict:
    ...
    logger.debug(
        "FREELMAPI_REQUEST: conversion start model={} msgs={}",
    ...
    logger.debug(
        "FREELMAPI_REQUEST: conversion done model={} msgs={} tools={}",
        body.get("model"),
